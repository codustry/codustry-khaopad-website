...
const en: HomeContent = {
  ...
  works: [
    ...
    {
      key: "183degree",
      story: "The parts bin for people who build",
      name: "183 Degree (183°)",
  ...
  distribution: [
    {
      ...
      note: "Our own ecommerce and OEM storefront — Stereolabs, Inovance, Omron, encoders and industrial electronics for production and development.",
    ...
    },
    {
      ...
      note: "The #1 US breathalyzer brand — FDA-approved, police-grade fuel cell technology.",
...
const th: HomeContent = {
  ...
  works: [
    ...
    {
      key: "183degree",
      story: "กล่องอะไหล่ของคนที่ลงมือสร้าง",
      name: "183 Degree (183°)",
  ...
  distribution: [
    {
      ...
      logo: "/images/brands/183degree.svg",
      logoClass: "h-9 w-auto md:h-10",
      note: "ร้านอีคอมเมิร์ซและ OEM ของเราเอง — Stereolabs, Inovance, Omron, เอ็นโค้ดเดอร์ และอิเล็กทรอนิกส์อุตสาหกรรม สำหรับงานผลิตและงานพัฒนา",
    ...
    },
    {
      ...
      logo: "/images/brands/bactrack.png",
      logoClass: "h-8 w-auto md:h-9",
      note: "แบรนด์เครื่องวัดแอลกอฮอล์อันดับ 1 ของสหรัฐฯ — รับรองโดย FDA ด้วยเซ็นเซอร์ Fuel Cell ระดับตำรวจ",
